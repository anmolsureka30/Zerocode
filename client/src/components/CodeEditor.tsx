...
export default function CodeEditor({ activeFile, files }: CodeEditorProps) {
  ...
  // Function to download files as zip
  const downloadZip = async () => {
    if (!window.JSZip || files.length === 0) {
      console.error('JSZip not loaded or no files to download');
      return;
    }
...
This app was generated by ZeroCode AI.
...
`;
      ...
      link.href = url;
      link.download = `zerocode-app-${Date.now()}.zip`;
    ...
    >
      ...
      <div className="flex items-center justify-between p-3 border-b border-gray-700 bg-gray-800">
        ...
        <button
          ...
          className="flex items-center space-x-2 px-3 py-1.5 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-600 disabled:cursor-not-allowed text-white text-sm rounded-md transition-colors duration-150"
        >
          {isDownloading ? (
            <>
